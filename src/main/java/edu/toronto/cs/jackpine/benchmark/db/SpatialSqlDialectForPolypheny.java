...
public class SpatialSqlDialectForPolypheny extends SqlDialectForPolypheny implements SpatialSqlDialect {
    ...
    public SupportedSqlDialect getSqlDialectType() {
        return SupportedSqlDialect.Polypheny;
    }
    ...
    public String getSelectAllFeaturesWithinADistanceFromPoint() {
        return "SELECT count(*) FROM arealm_merge WHERE ST_Distance(geom, ST_GeomFromText('Point (-97.7 30.30)', " + SRID + ")) < 1000000";
    }


    @Override
    public String getSelectTotalLength() {
        return "SELECT sum(ST_Length(shape))/1000 AS km_roads FROM edges_merge";
    }


    @Override
    public String getSelectTotalArea() {
        return "SELECT sum(ST_Area(geom)) AS area FROM areawater_merge";
    }


    @Override
    public String getSelectLongestLine() {
        return "SELECT fullname, ST_Length(geom) AS line FROM edges_merge order BY line DESC limit 1";
    }


    @Override
    public String getSelectLargestArea() {
        return "SELECT fullname, ST_Area(geom) AS area FROM areawater_merge order BY area DESC limit 1";
    }


    @Override
    public String getSelectDimensionPolygon() {
        return "select ST_Dimension(a.geom) from arealm_merge a";
    }


    @Override
    public String getSelectBufferPolygon() {
        return "select ST_Buffer(a.geom, 5280) from arealm_merge a";
    }


    @Override
    public String getSelectConvexHullPolygon() {
        return "select ST_ConvexHull(a.geom) from arealm_merge a";
    }


    @Override
    public String getSelectEnvelopeLine() {
        return "select ST_AsText(ST_Envelope(e.geom)) from edges_merge e limit 1000";
    }
    ...
    public String getSelectAreaOverlapsArea() {
        return "select a1.fullname from arealm_merge a1, arealm_merge a2 where ST_Overlaps(a1.geom, a2.geom)";
    }


    @Override
    public String getSelectAreaContainsArea() {
        return "select a1.fullname from arealm_merge a1, arealm_merge a2 where ST_Contains(a1.geom, a2.geom)";
    }


    @Override
    public String getSelectAreaWithinArea() {
        return "select a1.fullname from arealm_merge a1, arealm_merge a2 where ST_Within(a1.geom, a2.geom)";
    }


    @Override
    public String getSelectAreaTouchesArea() {
        return "select a1.fullname from arealm_merge a1, arealm_merge a2 where ST_Touches(a1.geom, a2.geom)";
    }


    @Override
    public String getSelectAreaEqualsArea() {
        return "select a1.fullname from arealm_merge a1, arealm_merge a2 where ST_equals(a1.geom, a2.geom)";
    }


    @Override
    public String getSelectAreaDisjointArea() {
        return "select count(*) from arealm_merge a1, arealm_merge a2 where ST_Disjoint(a1.geom, a2.geom)";
    }


    @Override
    public String getSelectLineIntersectsArea() {
        return "select a.fullname, e.fullname from arealm_merge a, edges_merge e where ST_Intersects(e.geom, a.geom)";
    }


    @Override
    public String getSelectLineCrossesArea() {
        return "select e.fullname from edges_merge e, arealm_merge a where ST_Crosses(e.geom, a.geom)";
    }


    @Override
    public String getSelectLineWithinArea() {
        return "select e.fullname from edges_merge e, arealm_merge a where ST_Within(e.geom, a.geom)";
    }


    @Override
    public String getSelectLineTouchesArea() {
        return "select e.fullname from edges_merge e, arealm_merge a where ST_Touches(e.geom, a.geom)";
    }


    @Override
    public String getSelectLineOverlapsArea() {
        return "select a.fullname, e.fullname from arealm_merge a, edges_merge e where ST_Overlaps(e.geom, a.geom)";
    }


    @Override
    public String getSelectLineOverlapsLine() {
        return "select e1.fullname from edges_merge e1, edges_merge e2 where ST_overlaps(e1.geom, e2.geom) limit 1";
    }


    @Override
    public String getSelectLineCrossesLine() {
        return "select e1.fullname from edges_merge e1, edges_merge e2 where ST_crosses(e1.geom, e2.geom) limit 1";
    }


    @Override
    public String getSelectPointEqualsPoint() {
        return "select count(*) from pointlm_merge p1, pointlm_merge p2 where ST_Equals(p1.geom, p2.geom)";
    }


    @Override
    public String getSelectPointWithinArea() {
        return "select count(*) from arealm_merge a, pointlm_merge p where ST_Within(p.geom, a.geom)";
    }


    @Override
    public String getSelectPointIntersectsArea() {
        return "select count(*) from arealm_merge a, pointlm_merge p where ST_Intersects(p.geom, a.geom)";
    }


    @Override
    public String getSelectPointIntersectsLine() {
        return "select count(*) from edges_merge e, pointlm_merge p where ST_Intersects(p.geom, e.geom)";
    }
    ...
    public String getInsertIntoEdgesMerge() {
	  ...
	  /*
	  sb.append("insert into edges_merge (statefp,countyfp,tlid, tfidl, tfidr, mtfcc, fullname, smid, lfromadd, ltoadd, rfromadd, rtoadd, zipl, zipr, featcat, hydroflg, railflg, roadflg, olfflg, passflg, divroad, exttyp, ttyp, deckedroad, artpath, persist, gcseflg, offsetl, offsetr, tnidf, tnidt, geom ) values ('48','001',74690317,205838157,205838661,'P0002','TEMP','447','','','','','','','','N','N','N','N','','','N','','','','','N','N','0',14062338,14062338,  ST_GeomFromText('MULTILINESTRING((-95.43954 31.581223,").append(nxt1)
    ...
    public String getInsertIntoArealmMerge() {
	  ...
	  /*
	  sb.append("insert into arealm_merge (statefp, countyfp, ansicode, areaid, fullname, mtfcc, geom) values ('48','001','','110223506483','TEMP','K1237', ST_GeomFromText('MULTIPOLYGON(((-95.835919 31.758732,-95.83358 31.758691,-95.83335 31.758687,-95.831252 31.75865,").append(nxt1)
...
;
    ...
    public String getSpatialWriteCleanupEdgesMerge() {
        return "delete from edges_merge where fullname='TEMP'";
    }


    @Override
    public String getSpatialWriteCleanupArealmMerge() {
        return "delete from arealm_merge where fullname='TEMP'";
    }


    @Override
    public String getCityStateForReverseGeocoding() {
        return "SELECT name, st, ST_Distance(geom, ST_GeomFromText(?, " + SRID + " )) as dist FROM cityinfo order by dist limit 1";
    }


    @Override
    public String getStreetAddressForReverseGeocoding() {
        return "SELECT fullname,lfromadd,ltoadd,rfromadd,rtoadd,zipl,zipr, ST_Distance(geom, ST_GeomFromText(?," + SRID + " ))  as d FROM edges_merge   where St_Intersects(geom, ST_GeomFromText(?," + SRID + "))    and distance(geom, ST_GeomFromText(?," + SRID + " )) < 0.1 and roadflg='Y' order by d limit 1";
    }


    @Override
    public String getGeocodingQuery() {
        return "select t.tlid, t.fraddr, t.fraddl, t.toaddr, t.toaddl," + " t.zipL, t.zipR, t.tolat, t.tolong, t.frlong, t.frlat," + " t.long1, t.lat1, t.long2, t.lat2, t.long3, t.lat3, t.long4, t.lat4," + " t.long5, t.lat5, t.long6, t.lat6, t.long7, t.lat7, t.long8, t.lat8," + " t.long9, t.lat9, t.long10, t.lat10, t.fedirp, t.fetype, t.fedirs from " + " geocoder_address " + " t where t.fename = ? and " + "(" + "       (t.fraddL <= ? and t.toaddL >= ?) or (t.fraddL >= ? and t.toaddL <= ?) " + "    or (t.fraddR <= ? and t.toaddR >= ?) or (t.fraddR >= ? and t.toaddR <= ?) " + ")" + "  and (t.zipL = ? or t.zipR = ?)";
    }


    @Override
    public String getMapSearchSiteSearchQuery( VisitScenario visitScenario ) {
        return "select gid, name, ST_AsText(geom) as location from gnis_names09  where state='TX' and name='" + visitScenario.getChosenPoiName() + "' and class='" + visitScenario.getChosenPoiClassName() + "' limit 1";
    }
    ...
    public String[] getMapSearchScenarioQueries( VisitScenario scenario ) {
        ...
        if ( nearestEssentialPoiClassOnceMatchStrings != null && nearestEssentialPoiClassOnceMatchStrings.length != 0 ) {
            for ( int i = 0; i < nearestEssentialPoiClassOnceMatchStrings.length; i++ ) {
                ...
                //?s: lon lat lon lat
                queries[queryIndex] = " select name, ST_AsText(geom) as location, distance(geom, ST_GeomFromText(?, " + SRID + " )) as dist from gnis_names09  where state='TX' and class like '%" + classOnce + "%' and " + "(distance(geom, ST_GeomFromText(?, " + SRID + " ))  <= " + VisitScenario.MAX_SEARCH_RADIUS + ") and gid <> ? order by dist limit 1";
            }
        }
        ...
        if ( nearestEssentialPoiNameOnceMatchStrings != null && nearestEssentialPoiNameOnceMatchStrings.length != 0 ) {
            for ( int i = 0; i < nearestEssentialPoiNameOnceMatchStrings.length; i++ ) {
                ...
                //?s: lon lat lon lat
                queries[queryIndex] = " select name, ST_AsText(geom) as location, ST_Distance(geom, ST_GeomFromText(?, " + SRID + " )) as dist from gnis_names09  where state='TX' and name like '%" + nameOnce + "%' and " + "(ST_distance(geom, ST_GeomFromText(?, " + SRID + " ))  <= " + VisitScenario.MAX_SEARCH_RADIUS + ") and gid <> ? order by dist limit 1";
            }
        }
        ...
        if ( nearestEssentialPoiNameOrMatchStrings != null && nearestEssentialPoiNameOrMatchStrings.length != 0 ) {
            StringBuilder nameOrMatchingStrings = new StringBuilder();
            for ( int i = 0; i < nearestEssentialPoiNameOrMatchStrings.length; i++ ) {
                String nameOr = nearestEssentialPoiNameOrMatchStrings[i];
                if ( i > 0 ) {
                    nameOrMatchingStrings.append( " or " );
                }
                nameOrMatchingStrings.append( "name like '%" ).append( nameOr ).append( "%'" );
            }
            //?s: lon lat lon lat
            queryIndex++;
            queries[queryIndex] = " select name, ST_AsText(geom) as location, ST_Distance(geom, ST_GeomFromText(?, " + SRID + " )) as dist from gnis_names09  where state='TX' and (" + nameOrMatchingStrings + ") and " + "(ST_distance(geom, ST_GeomFromText(?, " + SRID + " ))  <= " + VisitScenario.MAX_SEARCH_RADIUS + ") and gid <> ? order by dist limit 1";
        }
        ...
        if ( nearestEssentialPoiClassOrMatchStrings != null && nearestEssentialPoiClassOrMatchStrings.length != 0 ) {
            StringBuilder classOrMatchingStrings = new StringBuilder();
            for ( int i = 0; i < nearestEssentialPoiClassOrMatchStrings.length; i++ ) {
                String classOr = nearestEssentialPoiClassOrMatchStrings[i];
                if ( i > 0 ) {
                    classOrMatchingStrings.append( " or " );
                }
                classOrMatchingStrings.append( "class like '%" ).append( classOr ).append( "%'" );
            }
            //?s: lon lat lon lat
            queryIndex++;
            queries[queryIndex] = " select name, ST_astext(geom) as location, ST_distance(geom, ST_GeomFromText(?, " + SRID + " )) as dist from gnis_names09  where state='TX' and (" + classOrMatchingStrings + ") and " + "(ST_distance(geom, ST_GeomFromText(?, " + SRID + " ))  <= " + VisitScenario.MAX_SEARCH_RADIUS + ") and gid <> ? order by dist limit " + limit;
        }
        ...
        if ( nearestOptionalPoiNameOrMatchStrings != null && nearestOptionalPoiNameOrMatchStrings.length != 0 ) {
            ...
            //?s: lon lat lon lat
            queryIndex++;
            queries[queryIndex] = " select name, ST_astext(geom) as location, ST_distance(geom, ST_GeomFromText(?, " + SRID + " )) as dist from gnis_names09  where state='TX' and (" + nameOrMatchingStrings + ") and " + "(ST_distance(geom, ST_GeomFromText(?, " + SRID + " ))  <= " + VisitScenario.MAX_SEARCH_RADIUS + ") and gid <> ? order by dist limit " + limit;
        }
        ...
        if ( nearestOptionalPoiClassAnyMatchStrings != null && nearestOptionalPoiClassAnyMatchStrings.length != 0 ) {
            ...
            //?s: lon lat lon lat
            queryIndex++;
            queries[queryIndex] = " select name, ST_astext(geom) as location, ST_distance(geom, ST_GeomFromText(?, " + SRID + " )) as dist from gnis_names09  where state='TX' and (" + classOrMatchingStrings + ") and " + "(ST_distance(geom, ST_GeomFromText(?, " + SRID + " ))  <= " + VisitScenario.MAX_SEARCH_RADIUS + ") and gid <> ? order by dist limit 1";
        }
    ...
    public String[] getMapBrowseBoundingBoxQueries() {
        ...
        queries[0] = "SELECT gid, ST_AsTWKB(geom) as geom FROM gnis_names09 WHERE geom && ST_GeomFromText(?, " + SRID + ")";
        queries[1] = "SELECT gid, ST_AsTWKB(geom) as geom FROM arealm_merge WHERE geom && ST_GeomFromText(?, " + SRID + ")";
        queries[2] = "SELECT gid, ST_AsTWKB(geom) as geom FROM areawater_merge WHERE geom && ST_GeomFromText(?, " + SRID + ")";
        queries[3] = "SELECT gid, ST_AsTWKB(geom) as geom FROM pointlm_merge WHERE geom && ST_GeomFromText(?, " + SRID + ")";
        queries[4] = "SELECT gid, ST_AsTWKB(geom) as geom FROM edges_merge WHERE geom && ST_GeomFromText(?, " + SRID + ")";
