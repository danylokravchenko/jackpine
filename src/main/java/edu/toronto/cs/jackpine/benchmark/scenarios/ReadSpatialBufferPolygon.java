 ...
 */
@Slf4j
public class ReadSpatialBufferPolygon extends SpatialScenarioBase {
    ...
    public void prepare() throws Exception {
        ...
        if ( dialect.getSqlDialectType() == SpatialSqlDialect.SupportedSqlDialect.Mysql ) {
            log.error( "ReadSpatialBufferPolygon not supported for Mysql" );
        } else {
            pstmtArray = new PreparedStatement[1];
            String sql = dialect.getSelectBufferPolygon();
