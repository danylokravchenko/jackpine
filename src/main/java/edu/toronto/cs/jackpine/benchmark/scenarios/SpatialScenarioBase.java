...
public abstract class SpatialScenarioBase implements Scenario {
    ...
    public void initialize( Properties properties ) throws Exception {
        ...
        Column[] arealmColumns = new Column[]{ new Column( "OGR_FID", Types.INTEGER, -1, -1, true, true ), new Column( "SHAPE", Types.STRUCT ), //geometry
                new Column( "statefp", Types.VARCHAR, 3 ), new Column( "countyfp", Types.VARCHAR, 3 ), new Column( "ansicode", Types.VARCHAR, 8 ), new Column( "areaid", Types.VARCHAR, 22 ), new Column( "fullname", Types.VARCHAR, 100 ), new Column( "mtfcc", Types.VARCHAR, 5 ), };
        ...
        Column[] areawaterColumns = new Column[]{ new Column( "OGR_FID", Types.INTEGER, -1, -1, true, true ), new Column( "SHAPE", Types.STRUCT ), //geometry
                new Column( "statefp", Types.VARCHAR, 3 ), new Column( "countyfp", Types.VARCHAR, 3 ), new Column( "ansicode", Types.VARCHAR, 8 ), new Column( "hydroid", Types.VARCHAR, 22 ), new Column( "fullname", Types.VARCHAR, 100 ), new Column( "mtfcc", Types.VARCHAR, 5 ), };

        tableSet.addTable( SPATIAL_TABLES.areawater.toString(), SPATIAL_TABLES.areawater.ordinal(), areawaterColumns );

        Column[] edgesColumns = new Column[]{ new Column( "OGR_FID", Types.INTEGER, -1, -1, true, true ), new Column( "SHAPE", Types.STRUCT ), //geometry
                new Column( "statefp", Types.VARCHAR, 3 ), new Column( "countyfp", Types.VARCHAR, 3 ), new Column( "tlid", Types.DECIMAL, 10 ), new Column( "tfidl", Types.DECIMAL, 10 ), new Column( "tfidr", Types.DECIMAL, 10 ), new Column( "mtfcc", Types.VARCHAR, 5 ), new Column( "fullname", Types.VARCHAR, 100 ), new Column( "smid", Types.VARCHAR, 22 ), new Column( "lfromadd", Types.VARCHAR, 12 ), new Column( "ltoadd", Types.VARCHAR, 12 ), new Column( "rfromadd", Types.VARCHAR, 12 ), new Column( "rtoadd", Types.VARCHAR, 12 ), new Column( "zipl", Types.VARCHAR, 5 ), new Column( "zipr", Types.VARCHAR, 5 ), new Column( "featcat", Types.VARCHAR, 1 ), new Column( "hydroflg", Types.VARCHAR, 1 ), new Column( "railflg", Types.VARCHAR, 1 ), new Column( "roadflg", Types.VARCHAR, 1 ), new Column( "olfflg", Types.VARCHAR, 1 ), new Column( "passflg", Types.VARCHAR, 1 ),
                new Column( "divroad", Types.VARCHAR, 1 ), new Column( "exttyp", Types.VARCHAR, 1 ), new Column( "ttyp", Types.VARCHAR, 1 ), new Column( "deckedroad", Types.VARCHAR, 1 ), new Column( "artpath", Types.VARCHAR, 1 ), new Column( "persist", Types.VARCHAR, 1 ), new Column( "gcseflg", Types.VARCHAR, 1 ), new Column( "offsetl", Types.VARCHAR, 1 ), new Column( "offsetr", Types.VARCHAR, 1 ), new Column( "tnidf", Types.DECIMAL, 10 ), new Column( "tnidt", Types.DECIMAL, 10 ),

        };

        tableSet.addTable( SPATIAL_TABLES.edges.toString(), SPATIAL_TABLES.edges.ordinal(), edgesColumns );

        Column[] pointlmColumns = new Column[]{ new Column( "OGR_FID", Types.INTEGER, -1, -1, true, true ), new Column( "SHAPE", Types.STRUCT ), //geometry
                new Column( "statefp", Types.VARCHAR, 3 ), new Column( "countyfp", Types.VARCHAR, 3 ), new Column( "ansicode", Types.VARCHAR, 8 ), new Column( "areaid", Types.VARCHAR, 22 ), new Column( "fullname", Types.VARCHAR, 100 ), new Column( "mtfcc", Types.VARCHAR, 5 ), };
    ...
    */
        ...
        if ( analyzeCmd != null ) {
            log.info( "Running analyze command: " + analyzeCmd );
