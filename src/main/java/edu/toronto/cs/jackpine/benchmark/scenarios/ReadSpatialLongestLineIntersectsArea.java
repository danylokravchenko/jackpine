 ...
 */
@Slf4j
public class ReadSpatialLongestLineIntersectsArea extends SpatialScenarioBase {
    ...
    public void prepare() throws Exception {
        ...
        String[] sql = dialect.getSelectLongestLineIntersectsArea();
        pstmtArray[0] = conn.prepareStatement( sql[0] );
        pstmtArray[1] = conn.prepareStatement( sql[1] );

        System.out.println( pstmtArray[0] );
