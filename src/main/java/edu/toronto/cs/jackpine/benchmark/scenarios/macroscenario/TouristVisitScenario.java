 ...
 */
    ...
    final PoiLatLon[] TouristSites = { new PoiLatLon( "Johnson Space Center Museum", "Building", -98.4546547, 29.5174215 ), new PoiLatLon( "Armand Bayou Nature Center", "Building", -95.0985417, 29.5952301 ), new PoiLatLon( "Texas State Capitol", "Building", -97.7408387, 30.274375 ), new PoiLatLon( "Six Flags Over Texas", "Park", -97.0730646, 32.7548531 ), new PoiLatLon( "Padre Island National Seashore", "Park", -97.3835942, 26.9503319 ), new PoiLatLon( "Texas Motor Speedway", "Park", -97.2808501, 33.0351231 ), new PoiLatLon( "Lake Worth Beach", "Beach", -97.4530759, 32.8181838 ), new PoiLatLon( "Holiday Beach", "Beach", -97.058877, 27.8222496 ), new PoiLatLon( "East Shore", "Beach", -97.1141558, 27.8611367 ), new PoiLatLon( "Corpus Christi Beach", "Beach", -97.3869366, 27.8222484 ), new PoiLatLon( "Guadalupe Mountains", "Range", -104.8605035, 31.891227 ),
    ...
    final String[][] NearestEssentialPoiClassOrMatchOpts = { { "Park", "Forest", "Woods", "Trail" }, { "Cliff", "Summit", "Crater", "Valley" }, { "Lake", "Spring", "Stream", "Swamp" }, { "Beach", "Harbor", "Island" } };
